# Adja Meal Prise Calculator (AMPC) app  , Final Project
# Welcome to Adja Meal prize calculation
#----------------------------------------------------------------------------------#
import math  # Because we are doing calculation the user need to inport matLab first   
...
#----------------------------------------------------------------------------------#
#The user  will provide for the amount that will be used for payment
print()
...
if donate == "yes":      #If user answers yes, it rounds up the total price o the next whole number and deducts it from the payment amount
    ...
    print("Thank you. Enjoy the rest of your day.") # Finally I think the User 
